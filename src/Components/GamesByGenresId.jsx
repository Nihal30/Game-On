...
return (
  <div>
      <h2 className='font-bold text-[40px] dark:text-white mt-5'>{selctedGenresName} Games</h2>
  ...
  gap-6 mt-5'>
      {gameList.map((item)=>(
          ...
          cursor-pointer'>
              ...
              '>{item.name}<span className='p-1 rounded-sm  text-[10px]
               bg-green-100 text-green-700 font-medium ml-2'>{item.metacritic}</span></h2>
